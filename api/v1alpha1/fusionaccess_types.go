...
// +kubebuilder:validation:Enum=v5.2.3.5-2025.10.20.22.23.42
...
type FusionAccessSpec struct {
	...
	// +operator-sdk:csv:customresourcedefinitions:type=spec,displayName="IBM Storage Scale Version",order=2,xDescriptors={"urn:alm:descriptor:com.tectonic.ui:select:v5.2.3.5-2025.10.20.22.23.42"}
